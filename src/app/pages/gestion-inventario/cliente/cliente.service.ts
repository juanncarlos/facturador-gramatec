...
export class ClienteService {
  ...
  constructor() {
    ...
    this.datos = [
      ...
      { id: 4, tipoDocumento: 'otroDocumento', numeroDocumento: 12345678, nombre:'cliente 4', direccion: 'direcion 4', departamento: 'Ayacucho', provincia: 'Huamanga', distrito: 'Jesus Nazareno', correo: 'juan@gmail.com', celular: 968965059, activo: 'Activo', habido: 'Habido', nota: 'asdadasdasdasdas' },
